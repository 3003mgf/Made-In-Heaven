...
import { contactPreference, getUserOrders } from '../../features/user/userSlice';
...
const Account = () => {
  ...
  const { getPriceByCurrency, setLogged, refToastCheckoutAutocomplete } = globalContext;
  ...
  return ( 
    <div className={styles.wrapper}>
      ...
      <div className={`${styles.sections} ${fixSections && styles.fixed}`}>
        ...
        <div className={styles.section} style={{borderLeft:"1px solid #eae8e4", borderBottom:"2.5px solid #1f1f1f"}} onClick={()=> navigate("/account")}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.cardsTop}>
            <div className={styles.eachCard}>
              <h5><Translate>My Profile</Translate></h5>
              <p className={styles.loginCredential}><Translate>Email</Translate> • {user?.email}</p>
              <div className={styles.contactPreferences}>
                <p><Translate>Contact preferences</Translate></p>  
                ...
                <div className={`${styles.wishlist} ${userFavorites.length > 0 && styles.active}`}>
                    {
                      userFavorites.length ? (
                        userFavorites.map((el, index) =>{
                          return(
                            <div className={`${styles.wishlistItem} ${el.brand === "Dolce & Gabbana" && styles.dolce}`} key={index}>
