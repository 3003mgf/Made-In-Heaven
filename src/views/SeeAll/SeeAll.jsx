...
import SeeAllFilters from '../../modals/SeeAllFilters/SeeAllFilters';
...
const SeeAll = () => {
  ...
  return ( 
    <div className={`${styles.wrapper} createAccount`}>
      <AccountHeader refHeader={ref} dark={true} moreTopWhite={true}/>
      <SeeAllFilters/>
      <div className={styles.container}>
          ...
          <div className={styles.subTitle}>
              <span><Translate>{`All ${category ? category : "Items"}`}</Translate> <span className={styles.totalItems}>({showFilteredProducts ? finalFilteredProducts.length : brandProducts.length})</span></span>
              {
                category ? (
