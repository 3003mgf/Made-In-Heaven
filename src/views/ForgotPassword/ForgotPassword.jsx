    ...
    <div className={`${styles.wrapper} createAccount`}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.form}>
          <span>We noticed that you are experiencing difficulty accessing your account on Made In Heaven. Don't worry, we're here to help you regain access quickly and securely.</span>
