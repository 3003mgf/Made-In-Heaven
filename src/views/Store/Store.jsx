      ...
      <div className={styles.container}>
        ...
        <div className={styles.subHeader}>
          ...
          <div className={styles.subHeaderLeft}>
            <span className={styles.itemsLength}><Translate>All Items</Translate> <span className={styles.totalItems}>({showFilteredProducts ? finalFilteredProducts.length : allProducts.length})</span></span>
          </div>
