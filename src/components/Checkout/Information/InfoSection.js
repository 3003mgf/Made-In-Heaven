...
const Information = () => {
  ...
  const { refTop, refAutocomplete, refToastCheckoutAutocomplete, refZipCode, handleChangeAddress, shippingInfo, setShippingInfo, zipCodeRequired, setZipCodeRequired, shippingInfoInitialState, setShowInfo, setShowShipping, setShowZipCodeModal } = globalContext;
  ...
  return ( 
    <div className={`${styles.wrapper}`}>
      ...
      <div className={styles.goBackIcon} style={{width: "fit-content", cursor:"pointer"}}>
        <HiOutlineArrowNarrowLeft size={20} onClick={()=> setShowInfo(false)}/>
      </div>
      <div className={styles.sectionIndicator}>
        <div className={styles.stepIndicator}>
          <span>1</span>
        </div>
        <span className={styles.sectionTitle}><Translate>Delivery Address</Translate></span>
      </div>
      <div className={styles.addressesContainer}>
        <button onClick={()=> { setAutocomplete(!autocomplete) ; setShippingInfo(shippingInfoInitialState)}} className={autocomplete ? styles.btnSelected : ""}>
          <Translate>Google Autocomplete</Translate>
        </button>
        <button onClick={()=> { setAutocomplete(!autocomplete) ; setShippingInfo(shippingInfoInitialState)}} className={!autocomplete ? styles.btnSelected : ""}>
          <Translate>Set Manually</Translate>
        </button>
      </div>
              ...
              <div>
                <div className={styles.autocompleteForm}>
                  ...
                  <div className={styles.goToStep2}>
                    <button onClick={goToStep2}><Translate>Continue</Translate></button>
                  </div>
                </div>
                {/* PADDING DIV */}
                  ...
                  <form className={styles.Form}>
                    ...
                    <div className='form-floating mb-1 flex-grow-1 p-1 position-relative'>
                      ...
                      <div className={styles.infoZipCode} onClick={()=> setShowZipCodeModal(true)}>
                        <i className="fa-solid fa-circle-info" style={{color: "#1f1f1f", cursor:"pointer"}}></i>
                      </div>
                      <label htmlFor="city">Zip Code</label>
                    </div>
                    <div className='form-floating mb-1 w-100 p-1'>
