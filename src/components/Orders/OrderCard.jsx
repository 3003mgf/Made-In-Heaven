  ...
  const handleInvoice = () =>{ 
    var props = {
      ...
      business: {
          ...
          email: "maadeinheavenmgf@gmail.com",
          email_1: "madeinheavensupport@gmail.com",
          website: "madeninheaven-mgf.netlify.app",
      },
      contact: {
      ...
      invoice: {
          ...
          invDesc: "Thank you for choosing MIH, where luxury meets style. Your purchase not only supports our passion for high fashion but also allows us to continue curating exceptional pieces for discerning individuals like you.",
      },
      footer: {
          text: "All rights reserved @ Made In Heaven 2023",
      },
      pageEnable: true,
      pageLabel: "Page ",
    };
