...
const Header = () => {
  ...
  const { refHeader, setShowLoginModal, logged, setShowCartModal, setShowCollectionModal, showCollectionModal, setShowSearchModal, setCurrency, currency, showCurrencyDropdown, setShowCurrencyDropdown, showLanguageModal, setShowLanguageModal, showSearchModal} = globalContext;
    ...
    <div className={styles.wrapper} ref={refHeader}>
      ...
      <div className={styles.header}>
        <div className={styles.left}>
          ...
          <div className={styles.currency} style={{opacity: showCollectionModal || showLanguageModal ? 0 : 1}}>
          ...
          <span className={styles.linkSpan} onClick={()=> setShowCollectionModal(true)} style={{opacity: showCollectionModal || showLanguageModal ? "0" : "1"}}><Translate>COLLECTIONS</Translate></span>
          <span className={styles.linkSpan} style={{opacity: showCollectionModal || showLanguageModal ? "0" : "1", zIndex: "999"}} onClick={()=> setShowSearchModal(!showSearchModal)} data-search><Translate>SEARCH</Translate></span>
        </div>
