      ...
      <article className={`filterSeeAll ${styles.article}`} style={{right: showFilterModal ? "0px" : "-100vw", opacity: showFilterModal ? 1 : 0}}>
        ...
        <div className={styles.div}>
          ...
          </h3>
          {
            ourStore && (
              <div className={`${styles.loginInput} mb-4`}>
                <span><Translate>Brand</Translate> <span className={styles.optional}><Translate>optional</Translate></span></span>
          ...
          <div className={styles.loginInput}>
            <span><Translate>Category</Translate> <span className={styles.optional}><Translate>(optional)</Translate></span></span>
              <div className='position-relative'>
          ...
          <div className={styles.loginInput} style={{marginTop:"2.5rem"}}>
            <span><Translate>Color</Translate> <span className={styles.optional}><Translate>(optional)</Translate></span></span>
          ...
          <div className={styles.loginInput} style={{marginTop:"2.5rem"}}>
            <span><Translate>Price</Translate> <span className={styles.optional}><Translate>(optional)</Translate></span></span>
            ...
            <button className='d-flex justify-content-center align-items-center' onClick={ourStore ? handleStoreFilter : handleFilter} ref={refShowButton}>
              {
                ...
                wrapperClass=""
                visible={true}
              /> : message === "Products filtered" ? <Translate>{`Show ${filteredProducts.length} products`}</Translate> : <Translate>Search</Translate>
              }
            </button>
          </div>
        </div>
