...
const LanguageModal = ({moreTop, moreTopWhite}) => {
  ...
  return ( 
    <article className={`${styles.article} ${moreTop && styles.moreTop} ${moreTopWhite && styles.moreTopWhite}`} style={{opacity: showLanguageModal ? 1 : 0, visibility: showLanguageModal ? "visible" : "hidden", top: showLanguageModal ? ((moreTop || moreTopWhite) ? "12px" : "0px") : "-200px"}}>
      <div className={styles.div}>
        <div className={styles.languages}>
          <div onClick={()=> setLanguage("en")} className={styles.language} style={{borderLeft: moreTop ? "1px solid #1f1f1f" : "1px solid white", paddingLeft: "0.8rem"}}>
